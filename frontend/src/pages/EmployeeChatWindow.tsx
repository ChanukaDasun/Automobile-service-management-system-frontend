...
const appointment = {
  CustomerId: "user_33SWQDkGoK0Jll1m1CIxADUTKg7", // here this is the recipient id
  EmployeeId: "user_34s5drjxj1d5sl7iKnk7l2vWsQV", // here this is the sender id -> nickname
  CustomerName: "Chiran Dhanasekara",
  EmployeeName: "Chanuka Dasun", // full name
  status: "PENDING",
...
function EmployeeChatWindow() {
  ...
  const fetchMessages = async () => {
    console.log("Fetching messages for:", appointment.CustomerId, "And userId:", userId);
    const res = await fetch(
      `http://localhost:9000/api/messages/${userId}/${appointment.CustomerId}`
    );
    const data = await res.json();
  ...
  return (
    <div className="chat-container">
      ...
      <main className="chat-main">
          <>
            <h3>Chat with {appointment.CustomerName}</h3>
