...
// UI-focused enhancement: Preserve existing static behavior while elevating layout & visuals.
export default function Login() {
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-white via-slate-50 to-slate-100">
        ...
        <div className="relative z-10 flex max-w-xl flex-col gap-7 text-center md:text-left">
          <div className="relative">
            ...
            <h1 className="relative text-4xl font-extrabold leading-tight tracking-tight text-slate-900 md:text-5xl lg:text-6xl">
              Modern <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Service</span> Management
            </h1>
          </div>
          <p className="mx-auto max-w-lg text-base leading-relaxed text-slate-600 md:mx-0 md:text-lg">
            Book appointments, monitor real-time progress, and empower your team with a streamlined workflow built for automotive excellence.
          </p>
          ...
          <div className="mt-6 grid w-full max-w-xl grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              >
                <span className="text-xs font-semibold tracking-widest text-blue-600/80">{item.n}</span>
      ...
      {/* Placeholder sections for nav anchors (optional) */}
      <section id="about" className="mx-auto w-full max-w-7xl px-6 pb-24">
        <h2 className="mb-4 text-2xl font-semibold tracking-tight text-slate-900">About</h2>
        <p className="max-w-2xl text-slate-600 text-sm md:text-base">
          This platform centralizes customer requests, technician workflows, and service transparency. (Content placeholder)
        </p>
      </section>
      <section id="services" className="mx-auto w-full max-w-7xl px-6 pb-24">
        <h2 className="mb-4 text-2xl font-semibold tracking-tight text-slate-900">Services</h2>
        <p className="max-w-2xl text-slate-600 text-sm md:text-base">
          Outline of service categories goes here. (Content placeholder)
        </p>
      </section>
      <section id="prices" className="mx-auto w-full max-w-7xl px-6 pb-24">
        <h2 className="mb-4 text-2xl font-semibold tracking-tight text-slate-900">Prices</h2>
        <p className="max-w-2xl text-slate-600 text-sm md:text-base">
          Pricing table placeholder content. (Content placeholder)
        </p>
      </section>
      <section id="contact" className="mx-auto w-full max-w-7xl px-6 pb-24">
        <h2 className="mb-4 text-2xl font-semibold tracking-tight text-slate-900">Contact</h2>
        <p className="max-w-2xl text-slate-600 text-sm md:text-base">
          Contact details or form placeholder. (Content placeholder)
        </p>
      </section>
    </div>
  );
